...
WHISPER_CPU_THREADS_RAW = os.getenv("WHISPER_CPU_THREADS", "").strip()
WHISPER_CPU_THREADS = int(WHISPER_CPU_THREADS_RAW) if WHISPER_CPU_THREADS_RAW.isdigit() else None
